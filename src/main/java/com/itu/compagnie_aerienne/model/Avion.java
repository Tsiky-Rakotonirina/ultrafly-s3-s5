...
public class Avion {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "avion_generator")
    @SequenceGenerator(name = "avion_generator", sequenceName = "seq_avion", allocationSize = 1)
