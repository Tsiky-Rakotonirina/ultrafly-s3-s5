...
create table publicite_tarrif (
    ...
    duree_min numeric(5,2),
    duree_max numeric(5,2)
);
...
INSERT INTO publicite_tarrif (cout, date_tarif, duree_min, duree_max) VALUES (500000.00, '2025-01-01', 1.0, 1000000.0);
...
-- Pour la publicité diffusion 1 (vol 1) : 1 000 000 Ar de montant, 200 000 Ar reste à payer => CA = 800 000 Ar
INSERT INTO encaissement (publicite_diffusion_id, date_encaissement, montant, reste_a_payer) 
VALUES (1, '2026-01-15', 1000000.00, 200000.00);

-- Pour la publicité diffusion 2 (vol 1) : 1 500 000 Ar de montant, 0 Ar reste à payer => CA = 1 500 000 Ar
INSERT INTO encaissement (publicite_diffusion_id, date_encaissement, montant, reste_a_payer) 
VALUES (2, '2026-01-16', 1500000.00, 0.00);

-- Pour la publicité diffusion 3 (vol 2) : 2 000 000 Ar de montant, 500 000 Ar reste à payer => CA = 1 500 000 Ar
INSERT INTO encaissement (publicite_diffusion_id, date_encaissement, montant, reste_a_payer) 
VALUES (3, '2026-01-17', 2000000.00, 500000.00);

-- Pour la publicité diffusion 4 (vol 2) : 800 000 Ar de montant, 100 000 Ar reste à payer => CA = 700 000 Ar
INSERT INTO encaissement (publicite_diffusion_id, date_encaissement, montant, reste_a_payer) 
VALUES (4, '2026-01-18', 800000.00, 100000.00);
